...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { completely_arrived: @purchase_order.completely_arrived, completely_invoiced: @purchase_order.completely_invoiced, order_number: @purchase_order.order_number }
    end
  ...
  test "should update purchase_order" do
    put :update, id: @purchase_order, purchase_order: { completely_arrived: @purchase_order.completely_arrived, completely_invoiced: @purchase_order.completely_invoiced, order_number: @purchase_order.order_number }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
